...
CREATE EXTERNAL TABLE IF NOT EXISTS covid_reporting_lookup.dim_date (
   ...
   STORED AS TEXTFILE
   LOCATION 'abfs://lookup@covidreportingdl1234.dfs.core.windows.net/dim_date/'
...
CREATE EXTERNAL TABLE IF NOT EXISTS covid_reporting_lookup.dim_country (
   ...
   ROW FORMAT DELIMITED FIELDS TERMINATED BY ','
   STORED AS TEXTFILE
   LOCATION 'abfs://lookup@covidreportingdl1234.dfs.core.windows.net/dim_country/'
   TBLPROPERTIES ("skip.header.line.count"="1");
...
CREATE EXTERNAL TABLE IF NOT EXISTS covid_reporting_raw.testing (
   ...
   ROW FORMAT DELIMITED FIELDS TERMINATED BY ','
   STORED AS TEXTFILE
   LOCATION 'abfs://raw@covidreportingdl1234.dfs.core.windows.net/ecdc/testing/'
   TBLPROPERTIES ("skip.header.line.count"="1");
...
CREATE TABLE IF NOT EXISTS covid_reporting_processed.testing (
   ...
   ROW FORMAT DELIMITED FIELDS TERMINATED BY ','
   STORED AS TEXTFILE
   LOCATION 'abfs://processed@covidreportingdl1234.dfs.core.windows.net/ecdc/testing'
   TBLPROPERTIES ("skip.header.line.count"="1");
